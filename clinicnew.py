...
def clustering_experiments(embeddings, true_labels, embedding_name):
    results = []
    kmeans_cluster_values = [130, 150, 170]  # Adjusted for around 150 clusters
    ...
    hdbscan_parameters = [(10, 100), (15, 120), (20, 140)]  # Targeting clusters close to 150
    ...
    hac_cluster_values = [140, 150, 160]  # HAC values centered around 150
...
def main():
    # Load dataset
    file_path = "C:/Users/asus/Downloads/clustering/datasets/clinc/small.jsonl"
    ...
    output_path = "clinc150_clustering_results.csv"

...
def clustering_experiments(embeddings, true_labels, embedding_name):
    ...
    # KMeans clustering values for ~77 clusters
    kmeans_cluster_values = [60, 77, 90]
    ...
    # HDBSCAN parameters to target around 77 clusters
    hdbscan_parameters = [(5, 20), (10, 40), (15, 60)]
    ...
    # Agglomerative Clustering values around ~77 clusters
    hac_cluster_values = [70, 77, 85]
...
def main():
    # Load dataset
    file_path = "C:/Users/asus/Downloads/clustering/datasets/banking77/small.jsonl"
    ...
    output_path = "banking77_clustering_results.csv"

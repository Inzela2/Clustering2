...
#
# # Load the dataset
# def load_arxiv_dataset(file_path):
#     test_texts = []
#     true_labels = []
...
#     print("Generating embeddings for ollama (all-MiniLM-L6-v2)...")
#     embeddings = []
#     for text in test_texts:
...
#     print("Generating embeddings for stella_en_400M_v5...")
...
#             outputs = model(**inputs)
#         embeddings.append(outputs.last_hidden_state[:, 0, :].squeeze().numpy())
#     print("Embeddings for stella generated.")
#     return np.array(embeddings)
#
# def get_jina_embeddings(test_texts):
#     print("Generating embeddings for jina_embeddings_v3...")
...
#     results = []
#     kmeans_cluster_values = [30, 60, 90, 120, 150, 180]
...
#
#     hdbscan_parameters = [(3, 10), (5, 20), (10, 30)]
...
#
#     hac_cluster_values = [30, 60, 90, 120, 150, 180]
...
#     test_texts, true_labels = load_arxiv_dataset(file_path)
#
